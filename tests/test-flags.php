...
class TestFlags extends WP_UnitTestCase
{
	...
	public function test_location_flag()
	{
		...
		$this->assertEquals( '', Location::get_detected_value( array( 'non_supported_value' ) ), "The default empty string is returned when trying to detect a value not supported by the flag." );
	...
	public function test_source_flag()
	{
		...
		$this->assertEquals( '', Source::get_detected_value( array( 'non_supported_value' ) ), "The default empty string is returned when trying to detect a value not supported by the flag." );
